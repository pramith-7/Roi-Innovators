const NewsLatterBox = () => {
  return (
    <div
      className="wow fadeInUp relative z-10 rounded-md p-8 bg-primary/10 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-white">
        Subscribe to receive future updates
      </h3>
      <p className="mb-11 border-b pb-11 text-base font-medium leading-relaxed text-body-color border-white border-opacity-25">
      ...
      <form>
        <input
          ...
          className="mb-4 w-full rounded-md border  py-3 px-6 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-primary focus:0 focus-visible:shadow-none border-white border-opacity-10 bg-[#242B51] focus:border-opacity-50"
        />
        <input
          type="email"
          name="email"
          placeholder="Enter your email"
          className="mb-4 w-full rounded-md border py-3 px-6 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-primary focus-visible:shadow-none border-white border-opacity-10 bg-[#242B51] focus:border-opacity-50"
        />
        <input
          type="submit"
          value="Subscribe"
