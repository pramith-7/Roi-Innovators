...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <div className="w-full mt-10 ">
      <div
        className="wow fadeInUp rounded-xl shadow-md bg-gray-200/30 p-4 md:mx-0 mx-10 lg:px-5 xl:px-8 h-[400px] hover:-translate-y-4 transition-all duration-500 ease-in-out"
        data-wow-delay=".1s"
      >
